...
class GermanWordsControllerTest < ActionController::TestCase
  ...
  test "should create german_word" do
    assert_difference('GermanWord.count') do
      post :create, german_word: { chapter: @german_word.chapter, english_word_id: @german_word.english_word_id, word: @german_word.word }
    end
  ...
  test "should update german_word" do
    patch :update, id: @german_word, german_word: { chapter: @german_word.chapter, english_word_id: @german_word.english_word_id, word: @german_word.word }
    assert_redirected_to german_word_path(assigns(:german_word))
  end
